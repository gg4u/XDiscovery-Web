...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.thumbnail'
        db.add_column(u'xdw_core_map', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.thumbnail'
        db.delete_column(u'xdw_core_map', 'thumbnail')
